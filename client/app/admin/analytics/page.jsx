...
export default function AnalyticsPage() {
    ...
    useEffect(() => {
        const fetchAnalytics = async () => {
            ...
            try {
                const response = await fetch(`https://api.inflow.chat/api/analytics/profile/${currentProfileId}/stats?start=${dateRange.start.toISOString()}&end=${dateRange.end.toISOString()}`)
