...
export default function LoginPage() {
    ...
    const onSubmit = async (data) => {
        try {
            // Login request
            const response = await axios.post('https://linktree-backend-hky4.onrender.com/api/auth/login',
                data,
            ...
            const profileCount = await axios.get(`https://linktree-backend-hky4.onrender.com/api/${userData.id}/profile/count`,
                {
